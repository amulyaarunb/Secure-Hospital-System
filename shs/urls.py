...
urlpatterns = [
    ...
    path('hospital_patient_details/', views.hospital_patient_details,
         name='hospital_patient_details'),
    path('hospital_search/', views.hospital_search, name='hospital_search'),
    path('hospital_create_patients/', views.hospital_create_patients,
         name='hospital_create_patients'),
    path('hospital_update_patients/<str:ID>',
         views.hospital_update_patients, name='hospital_update_patients'),
    path('hospital_appointment_approve/<str:ID>',
         views.hospital_appointment_approve, name='hospital_appointment_approve'),
    path('hospital_appointment_reject/<str:ID>', views.hospital_appointment_reject, name='hospital_appointment_reject'),  path(
        'hospital_patient_details/<str:pID>', views.hospital_patient_details, name='hospital_patient_details'),
    path("hospital_view_lab_report/<str:testID>",
         views.hospital_view_lab_report, name="hospital_view_lab_report"),
    ...
    path('doctor_update_patients/<str:ID>',
         views.doctor_update_patients, name='doctor_update_patients'),
    path('doctor_delete_diagnosis/<str:ID>',
         views.doctor_delete_diagnosis, name='doctor_delete_diagnosis'),
    path('doctor_search_appointment', views.doctor_search_appointment,
         name='doctor_search_appointment'),
    path('doctor_view_labreport_view/<str:ID>',
         views.doctor_view_labreport_view, name='doctor_view_labreport_view')
