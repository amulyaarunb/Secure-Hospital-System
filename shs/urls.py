...
#     path('hospital_staff_create_payment/', views.hospital_transaction, name='hospital_staff_create_payment'),
    ...
    path("patient_labtest/request_labtest", views.request_test, name="request_labtest"),
    path("/patient_labtest/patient_view_lab_report/<str:patientID>", views.view_lab_report, name="view_lab_report"),
