...
urlpatterns = [
    ...
    path('hospital_staff_approve/<str:PatientID>',views.hospital_appointment_approve,name='approve appointment'),
    path('hospital_staff_reject/<str:PatientID>',views.hospital_appointment_reject,name='reject appointment'),
